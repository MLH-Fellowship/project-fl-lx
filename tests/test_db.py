...
class TestTimelinePost(unittest.TestCase):
    ...
    def tearDown(self):
        # Not strictly necessary since SQLite in-memory databases only live for the duration of the connection, and in the next step we close the connection ... but good practice
